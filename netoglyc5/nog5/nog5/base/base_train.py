...
from nog5.utils.visualization import TensorboardWriter
...
class TrainerBase:
    ...
    def __init__(self, model: ModelBase, loss: any, metrics: list, optimizer: Optimizer,
                 start_epoch: int, config: dict, device: torch.device):
        """ Constructor
        Args:
    ...
    def _save_checkpoint(self, epoch: int, save_best: bool = False):
        ...
        if isinstance(self.loss, ParameterizedLossBase):
